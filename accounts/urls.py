...
urlpatterns = [
    ...
    path("book_appointment/", login_required(views.BookAppointmentView.as_view()),name='book_appointment'),
    path("appointment_details/<pk>/", login_required(views.AppointmentDetailsView.as_view()),name='appointment_details'),
